...
public class SessionServiceTest {
    ...
    @Test
    void testCreate_ShouldReturnSavedSession() {
    ...
    void testFindAll_ShouldReturnListOfSessions() {
        ...
        System.out.println("Nombre de sessions attendues: " + expectedSessions.size());
        ...
        System.out.println("Nombre de sessions retournées: " + actualSessions.size());
    ...
    @Test
    void testGetById_WhenSessionExists_ShouldReturnSession() {
        // Given - Préparation des données
        Long sessionId = 1L;
    ...
    @Test
    void testGetById_WhenSessionNotExists_ShouldReturnNull() {
        // Given - Préparation des données
        Long sessionId = 999L;
    ...
    @Test
    void testUpdate_ShouldReturnUpdatedSession() {
        // Given - Préparation des données
        Long sessionId = 1L;
        Session inputSession = new Session();
    ...
    @Test
    void testParticipate_WhenValidSessionAndUser_ShouldAddUserToSession() {
        // Given - Préparation des données
        Long sessionId = 1L;
        Long userId = 1L;
    ...
    @Test
    void testParticipate_WhenSessionNotExists_ShouldThrowNotFoundException() {
        // Given - Préparation des données
        Long sessionId = 999L;
        Long userId = 1L;
    ...
    @Test
    void testParticipate_WhenUserNotExists_ShouldThrowNotFoundException() {
        // Given - Préparation des données
        Long sessionId = 1L;
        Long userId = 999L;
    ...
    @Test
    void testParticipate_WhenUserAlreadyParticipates_ShouldThrowBadRequestException() {
        // Given - Préparation des données
        Long sessionId = 1L;
        Long userId = 1L;
        ...
        System.out.println("User déjà participant, participants actuels: " + session.getUsers().size());
    ...
    /*-------------------------- NO LONGER PARTICIPATE (retirer un utilisateur participant) ------------------------------ */

    @Test
    void testNoLongerParticipate_WhenUserParticipates_ShouldRemoveUserFromSession() {
        // Given - Préparation des données
        Long sessionId = 1L;
        Long userId = 1L;
    ...
    /*-------------------------- NO LONGER PARTICIPATE (Session inexistante) ------------------------------ */

    @Test
    void testNoLongerParticipate_WhenSessionNotExists_ShouldThrowNotFoundException() {
        // Given - Préparation des données
        Long sessionId = 999L;
        Long userId = 1L;
    ...
    @Test
    void testNoLongerParticipate_WhenUserNotParticipating_ShouldThrowBadRequestException() {
        // Given - Préparation des données
        Long sessionId = 1L;
