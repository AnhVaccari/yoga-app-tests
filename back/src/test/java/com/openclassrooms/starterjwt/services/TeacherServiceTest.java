...
public class TeacherServiceTest {
  ...
  /*---------------- GET All teachers ----------------*/
  @Test
  void shouldReturnListOfTeachers_WhenTeachersExist() {
    ...
    // System.out.println("Nombre de teachers attendus: " +
    // expectedTeachers.size());
  ...
  void shouldReturnTeacher_WhenTeacherExists() {
    ...
    // System.out.println("Teacher attendu: " + expectedTeacher.getFirstName() + " "
  ...
  @Test
  void shouldReturnNull_WhenTeacherNotExists() {
    // Given - Préparation des données
    Long teacherId = 999L;
